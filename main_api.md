...
- `GET/POST/PUT/DELETE /api/data/gym/workouts` - Manage gym workouts
- `GET/POST/PUT/DELETE /api/data/gym/exercises/*` - Manage gym exercises
- `GET/POST/PUT/DELETE /api/data/gym/sets/*` - Manage gym sets
...
- `notes`, `settings`
- `gym_workout_plans`, `gym_exercises`, `gym_workout_logs`, `gym_set_logs`, `gym_body_metrics`, `gym_personal_records`
